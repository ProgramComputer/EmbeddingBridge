...
def print_test_commands():
    ...
    print("   eb store test_files/technical_doc.txt.openai.npy test_files/technical_doc.txt")
    print("   eb store test_files/api_design.md.openai.npy test_files/api_design.md")
    print("   # Store VoyageAI embeddings")
    print("   eb store test_files/technical_doc.txt.voyage.npy test_files/technical_doc.txt")
    print("   eb store test_files/api_design.md.voyage.npy test_files/api_design.md")
    print("   # Store binary format embeddings")
    print("   eb store test_files/technical_doc.txt.openai.bin test_files/technical_doc.txt")
    print("   eb store test_files/api_design.md.openai.bin test_files/api_design.md")
    print("   eb store test_files/technical_doc.txt.voyage.bin test_files/technical_doc.txt")
    print("   eb store test_files/api_design.md.voyage.bin test_files/api_design.md")
    
    print("\n4. Check the status of your files:")
    print("   eb status test_files/technical_doc.txt")
    print("   eb status test_files/api_design.md")
    
    print("\n5. Store the modified embeddings (which were created by setup script):")
    print("   # Store modified OpenAI embeddings")
    print("   eb store test_files/technical_doc.txt.modified.openai.npy test_files/technical_doc.txt")
    print("   eb store test_files/api_design.md.modified.openai.npy test_files/api_design.md")
    print("   # Store modified VoyageAI embeddings")
    print("   eb store test_files/technical_doc.txt.modified.voyage.npy test_files/technical_doc.txt")
    print("   eb store test_files/api_design.md.modified.voyage.npy test_files/api_design.md")
    print("   # Store modified binary format embeddings")
    print("   eb store test_files/technical_doc.txt.modified.openai.bin test_files/technical_doc.txt")
    print("   eb store test_files/api_design.md.modified.openai.bin test_files/api_design.md")
    print("   eb store test_files/technical_doc.txt.modified.voyage.bin test_files/technical_doc.txt")
    print("   eb store test_files/api_design.md.modified.voyage.bin test_files/api_design.md")
    
    print("\n6. View the history of changes:")
    print("   eb log test_files/technical_doc.txt")
    print("   eb log test_files/api_design.md")
    
    print("\n7. Compare different versions using diff:")
    print("   # Compare files directly")
    print("   eb diff <hash> <hash>")
    ...
    print("   eb rollback test_files/technical_doc.txt")
    print("   eb rollback test_files/api_design.md")
    ...
    print("   eb remote add s3-test s3://embeddingbridge-test")
    print("   eb remote list")
    print("   # Push your embeddings to the remote")
    print("   eb remote push s3-test")
    print("   # Pull embeddings from the remote")
    print("   eb remote pull s3-test")
    
    print("\n10. Test the set functionality:")
    print("   # Create a new set")
    print("   eb set create test-set \"Test set for embeddings\"")
    print("   # Check available sets")
    print("   eb set list")
    print("   # Switch to the test set")
    print("   eb set switch test-set")
